...
import { Modal, useSessionTimeout } from '@berhot/ui';
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <Modal open={session.phase === 'warning'} width={420}>
        <div style={{
          ...
          <p style={{ fontSize: 15, color: '#6b7280', lineHeight: 1.5, margin: '0 0 8px 0' }}>
          ...
          <div style={{
            fontSize: 36,
            fontWeight: 700,
            color: session.secondsLeft <= 10 ? '#ef4444' : '#111827',
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 20,
                  border: '1px solid #e5e5e5',
                  background: hoveredExtend === opt.label ? '#f3f4f6' : 'transparent',
                  color: '#111827',
                  fontSize: 13,
                  fontWeight: 500,
                  cursor: 'pointer',
      ...
      >
        <div style={{
          ...
          <p style={{ fontSize: 15, color: '#6b7280', lineHeight: 1.5, margin: '0 0 24px 0' }}>
